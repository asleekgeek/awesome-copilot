...
- **Client ID Metadata Document (CIMD)** *(v1.0.83+)*: MCP servers that support CIMD-based OAuth can sign you in without requiring manual client registration, streamlining first-time authentication.
